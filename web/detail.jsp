...
<div id="top">
  <div id="navtop">
    <div class="ntleft">
      <a href="index.jsp">小米商城</a> | <a href="#">MIUI</a> | <a href="#">IoT</a> | <a href="#">云服务</a> | <a href="#">金融</a> |
...
<div id="container">
  ...
  <div id="goods-nav">
    <div id="goods-on">
      <a href="#" id="goods_type">Redmi Note 8</a>
      | <a href="#" id="goods_detail">Redmi Note 8 Pro</a>
    </div>
  ...
  <div id="detail">
    ...
    <!-- 图片轮播 560x560 -->
    <div id="dtleft">
      <img src="/xiaomi/static/images/detail.jpg" alt="">
    </div>
    <!-- 商品介绍 -->
    <div id="dtright">
...
<script>
  // 入口函数
  $(function () {
    // 获取到查询商品的编号 xiaomi/detail.jsp?gid=6
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        let $goodsType = response.objectMap.goodsType;
        // 更新商品编号
        $("#goodsId").val($goods.id);
        // 更新商品的类型
        $("#goods_type").text($goodsType.name);
        $("#goods-nav > div").on("click", "a", function () {
          // http://localhost/xiaomi/goodsList2.jsp?level=1&goodsTypeId=103
          window.location = "/xiaomi/goodsList2.jsp?level=2&goodsTypeId=" + $goodsType.id;
        });
        // 更新商品的名称
        $("#goods-name").text($goods.name);
        $("#goods_detail").text($goods.name);
        // 更新商品描述
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.errorCode === "100") {
            alert("Congratulations，商品加入购物车成功！");
          } else {
